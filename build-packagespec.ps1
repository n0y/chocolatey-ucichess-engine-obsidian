...
(Get-Content .\src\ucichess-engine-obsidian.template.nuspec.xml) -replace '%%VERSION%%', $UpstreamVersion | Out-File -Encoding utf8 ".\target\ucichess-engine-obsidian.nuspec"
